...
var format_Identified_sites_network_plan_16062026_4 = new ol.format.GeoJSON();
var features_Identified_sites_network_plan_16062026_4 = format_Identified_sites_network_plan_16062026_4.readFeatures(json_Identified_sites_network_plan_16062026_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Identified_sites_network_plan_16062026_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Identified_sites_network_plan_16062026_4.addFeatures(features_Identified_sites_network_plan_16062026_4);
var lyr_Identified_sites_network_plan_16062026_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Identified_sites_network_plan_16062026_4, 
                style: style_Identified_sites_network_plan_16062026_4,
                popuplayertitle: 'Identified_sites_network_plan_16.06.2026',
                interactive: true,
    title: 'Identified_sites_network_plan_16.06.2026<br />\
    <img src="styles/legend/Identified_sites_network_plan_16062026_4_0.png" /> GRID<br />\
    <img src="styles/legend/Identified_sites_network_plan_16062026_4_1.png" /> SOLAR<br />' });
var format_Plannedsites_network_plan_16062026_5 = new ol.format.GeoJSON();
var features_Plannedsites_network_plan_16062026_5 = format_Plannedsites_network_plan_16062026_5.readFeatures(json_Plannedsites_network_plan_16062026_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Plannedsites_network_plan_16062026_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Plannedsites_network_plan_16062026_5.addFeatures(features_Plannedsites_network_plan_16062026_5);
var lyr_Plannedsites_network_plan_16062026_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Plannedsites_network_plan_16062026_5, 
                style: style_Plannedsites_network_plan_16062026_5,
                popuplayertitle: 'Planned sites_network_plan_16.06.2026',
                interactive: true,
    title: 'Planned sites_network_plan_16.06.2026<br />\
    <img src="styles/legend/Plannedsites_network_plan_16062026_5_0.png" /> GRID<br />\
    <img src="styles/legend/Plannedsites_network_plan_16062026_5_1.png" /> SOLAR<br />' });

lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_beninnewscores_1.setVisible(true);lyr_departmentboundaries_2.setVisible(true);lyr_Activesites_16062026_3.setVisible(true);lyr_Identified_sites_network_plan_16062026_4.setVisible(true);lyr_Plannedsites_network_plan_16062026_5.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_beninnewscores_1,lyr_departmentboundaries_2,lyr_Activesites_16062026_3,lyr_Identified_sites_network_plan_16062026_4,lyr_Plannedsites_network_plan_16062026_5];
...
lyr_Identified_sites_network_plan_16062026_4.set('fieldLabels', {'fid': 'no label', 'Sno.': 'no label', 'SS ID': 'no label', 'SS name': 'no label', 'District/s': 'no label', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Status': 'no label', 'Comments': 'no label', 'id': 'no label', 'Type': 'inline label - always visible', 'Sites vis�': 'no label', 'Espace vis': 'no label', '0bservatio': 'no label', 'surface au': 'no label', 'surface de': 'no label', 'Lat': 'no label', 'Long': 'no label', 'X': 'no label', 'Y': 'no label', 'field_10': 'no label', 'field_11': 'no label', 'field_12': 'no label', 'field_13': 'no label', 'layer': 'no label', 'path': 'no label', });
lyr_Plannedsites_network_plan_16062026_5.set('fieldLabels', {'fid': 'no label', 'Sno.': 'no label', 'SS ID': 'no label', 'SS name': 'no label', 'District/s': 'no label', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Status': 'no label', 'Comments': 'no label', 'id': 'no label', 'Type': 'inline label - always visible', 'Sites vis�': 'no label', 'Espace vis': 'no label', '0bservatio': 'no label', 'surface au': 'no label', 'surface de': 'no label', 'Lat': 'no label', 'Long': 'no label', 'X': 'no label', 'Y': 'no label', 'field_10': 'no label', 'field_11': 'no label', 'field_12': 'no label', 'field_13': 'no label', 'layer': 'no label', 'path': 'no label', });
lyr_Plannedsites_network_plan_16062026_5.on('precompose', function(evt) {
